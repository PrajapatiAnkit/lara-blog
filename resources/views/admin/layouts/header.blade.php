                ...
                <ul class="dropdown-menu">
                    ...
                    <li>
                        <ul class="ovY-a pos-r scrollable lis-n p-0 m-0 fsz-sm">
                            <li>
                                <a href="#" class="peers fxw-nw td-n p-20 bdB c-grey-800 cH-blue bgcH-grey-100">
                                    <div class="peer mR-15">
                                        <img class="w-3r bdrs-50p" src="{{asset('static/adminator/randomuser.me/api/portraits/men/1.jpg')}}" alt="">
                                    </div>
                            ...
                            <li>
                                <a href="#" class="peers fxw-nw td-n p-20 bdB c-grey-800 cH-blue bgcH-grey-100">
                                    <div class="peer mR-15"><img class="w-3r bdrs-50p" src="{{asset('static/adminator/randomuser.me/api/portraits/men/2.jpg')}}" alt=""></div>
                            ...
                            <li>
                                <a href="#" class="peers fxw-nw td-n p-20 bdB c-grey-800 cH-blue bgcH-grey-100">
                                    <div class="peer mR-15"><img class="w-3r bdrs-50p" src="{{asset('static/adminator/randomuser.me/api/portraits/men/3.jpg')}}" alt=""></div>
                ...
                <ul class="dropdown-menu">
                    ...
                    <li>
                        <ul class="ovY-a pos-r scrollable lis-n p-0 m-0 fsz-sm">
                            <li>
                                <a href="#" class="peers fxw-nw td-n p-20 bdB c-grey-800 cH-blue bgcH-grey-100">
                                    <div class="peer mR-15"><img class="w-3r bdrs-50p" src="{{asset('static/adminator/randomuser.me/api/portraits/men/1.jpg')}}" alt=""></div>

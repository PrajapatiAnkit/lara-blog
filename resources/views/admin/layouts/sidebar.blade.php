<div class="sidebar">
    <div class="sidebar-inner">
            ...
            <div class="peers ai-c fxw-nw">
                <div class="peer peer-greed">
                    <a class="sidebar-link td-n" href="index-2.html" class="td-n">
                        <div class="peers ai-c fxw-nw">
                            <div class="peer">
                                <div class="logo"><img src="{{asset('static/adminator/assets/static/images/logo.png')}}" alt=""></div>
                            </div>
                            <div class="peer peer-greed">
        ...
        <ul class="sidebar-menu scrollable pos-r">
            <li class="nav-item mT-30 active"><a class="sidebar-link" href="{{route('dashboard')}}" default><span class="icon-holder"><i class="c-blue-500 ti-home"></i> </span><span class="title">Dashboard</span></a></li>
            <li class="nav-item"><a class="sidebar-link" href="{{route('categories')}}"><span class="icon-holder"><i class="c-brown-500 ti-email"></i> </span><span class="title">Categories</span></a></li>
            <li class="nav-item"><a class="sidebar-link" href="{{route('addBlog')}}"><span class="icon-holder"><i class="c-brown-500 ti-email"></i> </span><span class="title">Add Blog</span></a></li>
            <li class="nav-item"><a class="sidebar-link" href="{{route('blogList')}}"><span class="icon-holder"><i class="c-blue-500 ti-share"></i> </span><span class="title">Blog List</span></a></li>
            <li class="nav-item"><a class="sidebar-link" href="{{route('usersList')}}"><span class="icon-holder"><i class="c-deep-orange-500 ti-calendar"></i> </span><span class="title">Users List</span></a></li>

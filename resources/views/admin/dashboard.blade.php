                            ...
                            <div class="layer w-100">
                                <div class="bgc-grey-200 p-20 gapY-15">
                                    <div class="peers fxw-nw">
                                        <div class="peer mR-20"><img class="w-2r bdrs-50p" src="{{asset('static/adminator/randomuser.me/api/portraits/men/11.jpg')}}" alt=""></div>
                                        <div class="peer peer-greed">
                                    ...
                                    <div class="peers fxw-nw ai-fe">
                                        <div class="peer ord-1 mL-20"><img class="w-2r bdrs-50p" src="{{asset('static/adminator/randomuser.me/api/portraits/men/12.jpg')}}" alt=""></div>

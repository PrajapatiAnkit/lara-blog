                ...
                <div class="owl-carousel active-stories-carousel">
                    ...
                    <div class="single-stories-carousel d-flex align-items-center">
                        <div class="stories-thumb">
                            <img class="img-fluid" src="{{asset('static/bounty/img/posts/carousel/stories1.jpg')}}" alt="">
                        </div>
                    ...
                    <div class="single-stories-carousel d-flex align-items-center">
                        <div class="stories-thumb">
                            <img class="img-fluid" src="{{asset('static/bounty/img/posts/carousel/stories2.jpg')}}" alt="">
                        </div>
                        <div class="stories-details">
                            <h6><a href="">2nd Gen Smoke Alarm <br>
                                    get up from sleep</a></h6>
                    ...
                    <div class="single-stories-carousel d-flex align-items-center">
                        <div class="stories-thumb">
                            <img class="img-fluid" src="{{asset('static/bounty/img/posts/carousel/stories3.jpg')}}" alt="">
                        </div>
                        <div class="stories-details">
                            <h6><a href="">2nd Gen Smoke Alarm <br>
                                    get up from sleep</a></h6>
                    ...
                    <div class="single-stories-carousel d-flex align-items-center">
                        <div class="stories-thumb">
                            <img class="img-fluid" src="{{asset('static/bounty/img/posts/carousel/stories4.jpg')}}" alt="">
                        </div>
                        <div class="stories-details">
                            <h6><a href="">2nd Gen Smoke Alarm <br>
                                    get up from sleep</a></h6>
                    ...
                    <div class="single-stories-carousel d-flex align-items-center">
                        <div class="stories-thumb">
                            <img class="img-fluid" src="{{asset('static/bounty/img/posts/carousel/stories5.jpg')}}" alt="">
                        </div>
                        <div class="stories-details">
                            <h6><a href="">2nd Gen Smoke Alarm <br>
                                    get up from sleep</a></h6>
                    ...
                    <div class="single-stories-carousel d-flex align-items-center">
                        <div class="stories-thumb">
                            <img class="img-fluid" src="{{asset('static/bounty/img/posts/carousel/stories6.jpg')}}" alt="">
                        </div>
                        <div class="stories-details">
                            <h6><a href="">2nd Gen Smoke Alarm <br>
                                    get up from sleep</a></h6>
...
<section class="post-slider-area" style="display: none">
    <div class="container-fluid">
                ...
                <div class="owl-carousel active-post-carusel">
                    ...
                    <div class="single-post-carousel">
                        <div class="post-thumb">
                            <img class="img-fluid" src="{{asset('static/bounty/img/posts/carousel/post1.jpg')}}" alt="">
                        </div>
                        <div class="post-details">
                            ...
                            <div class="post-content d-flex justify-content-between">
                                <div class="post-meta">
                                    <div class="thumb"><img src="{{asset('static/bounty/img/author/a1.png')}}" alt=""></div>
                                    <div class="c-desc">
                                        <h6>Marvel Maison</h6>
                    ...
                    <div class="single-post-carousel">
                        <div class="post-thumb">
                            <img class="img-fluid" src="{{asset('static/bounty/img/posts/carousel/post2.jpg')}}" alt="">
                        </div>
                        <div class="post-details">
                            <h2><a href="#">2nd Gen Smoke Alarm get up <br>
                                    from sleep Daily</a></h2>
                    ...
                    <div class="single-post-carousel">
                        <div class="post-thumb">
                            <img class="img-fluid" src="{{asset('static/bounty/img/posts/carousel/post3.jpg')}}" alt="">
                        </div>
                        <div class="post-details">
                            <h2><a href="#">2nd Gen Smoke Alarm get up <br>
                                    from sleep Daily</a></h2>
        ...
        <div class="row">
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-6">
                            <div class="single-post-item">
                                <div class="post-thumb">
                                    <img class="img-fluid" src="{{asset('static/bounty/img/archive/c1.jpg')}}" alt="">
                                </div>
                                <div class="post-details">
                        ...
                        <div class="col-lg-6 col-md-6">
                            <div class="single-post-item">
                                <div class="post-thumb">
                                    <img class="img-fluid" src="{{asset('static/bounty/img/archive/c2.jpg')}}" alt="">
                                </div>
                                <div class="post-details">
                                    <h4><a href="#">An Stormy Evening</a></h4>
                                    <p>There is a moment in the life of any aspiring astronomer that it is time to buy that first telescope. It’s
                        ...
                        <div class="col-lg-6 col-md-6">
                            <div class="single-post-item">
                                <div class="post-thumb">
                                    <img class="img-fluid" src="{{asset('static/bounty/img/archive/c3.jpg')}}" alt="">
                                </div>
                                <div class="post-details">
                                    <h4><a href="#">An Stormy Evening</a></h4>
                                    <p>There is a moment in the life of any aspiring astronomer that it is time to buy that first telescope. It’s
                        ...
                        <div class="col-lg-6 col-md-6">
                            <div class="single-post-item">
                                <div class="post-thumb">
                                    <img class="img-fluid" src="{{asset('static/bounty/img/archive/c4.jpg')}}" alt="">
                                </div>
                                <div class="post-details">
                                    <h4><a href="#">An Stormy Evening</a></h4>
                                    <p>There is a moment in the life of any aspiring astronomer that it is time to buy that first telescope. It’s
            ...
            <div class="col-lg-4 sidebar">
                <div class="single-widget protfolio-widget">
                    <img class="img-fluid" src="{{asset('static/bounty/img/blog/user2.png')}}" alt="">
                    <a href="#">
                    ...
                    <ul>
                        <li>
                            <a href="#" class="justify-content-between align-items-center d-flex">
                                <p><img src="{{asset('static/bounty/img/bullet.png')}}" alt="">International (56)</p>
                            </a>
                        </li>
                        <li>
                            <a href="#" class="justify-content-between align-items-center d-flex">
                                <p><img src="{{asset('static/bounty/img/bullet.png')}}" alt="">Tours and Travels (45)</p>
                            </a>
                        </li>
                        <li>
                            <a href="#" class="justify-content-between align-items-center d-flex">
                                <p><img src="{{asset('static/bounty/img/bullet.png')}}" alt="">Cooking Tips (23)</p>
                            </a>
                        </li>
                        <li>
                            <a href="#" class="justify-content-between align-items-center d-flex">
                                <p><img src="{{asset('static/bounty/img/bullet.png')}}" alt="">Life Style and Fashion (72)</p>
                            </a>
                        </li>
                        <li>
                            <a href="#" class="justify-content-between align-items-center d-flex">
                                <p><img src="{{asset('static/bounty/img/bullet.png')}}" alt="">Organic News (37)</p>
                            </a>
                        </li>
                        <li>
                            <a href="#" class="justify-content-between align-items-center d-flex">
                                <p><img src="{{asset('static/bounty/img/bullet.png')}}" alt="">Games and Sports (19)</p>
                            </a>
                        </li>
                    </ul>
                </div>
